...
class dnfTestSuite(unittest.TestCase):
    def test_download(self):
        rpm_dict = {}
        rpm_name = dnf.download("Cython-0.29.13-6.cm1.src.rpm", data_dir  + "/", "python3-Cython", rpm_dict)
    ...
    def test_generate_abidiffs_output(self):
        ...
        dnf.generate_abidiffs("Cython-0.29.13-6.cm1.src.rpm", "data/", new_json_file, old_json_file, "data/output_abidiffs/", False)
